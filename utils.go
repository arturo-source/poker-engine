...
const (
	NO_CARD   Card = 0
	ONE_SUIT  Card = 0b1111111111111
	ALL_CARDS Card = 0b1111111111111111111111111111111111111111111111111111
)
...
const (
	TWOS Card = 0b0000000000001000000000000100000000000010000000000001 << iota
	THREES
	FOURS
	FIVES
	SIXS
